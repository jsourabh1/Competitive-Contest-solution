...
#question link:-https://codeforces.com/contest/1523/problem/A
...
def solve():
    ...
    for i in range(n):
        ...
        if index[k]==i:
            ...
            if (min(abs(i-index[k-1]),abs(index[k]-i))<=m and abs(i-index[k-1])!=abs(index[k]-i)):
                string[i]='1'
