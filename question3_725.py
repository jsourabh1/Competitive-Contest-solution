...
def solve():
	...
	# 	count-=bisect_left(arr,l-arr[i],0,n)
	# 	# print("left",bisect_left(arr,l-arr[i],0,n))
	# 	count+=bisect_right(arr,r-arr[i],0,n)
	# 	# print("right",bisect_right(arr,r-arr[i],0,n))
