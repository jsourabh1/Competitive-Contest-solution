...
sys.setrecursionlimit(20*20*20*20*20+10) #this is must for dfs
MAX=10**5
...
def bfs(node,adj,count):

	global visit,far,maxcount

	visit[node]=1

	count+=1

	for i range(len(adj[node])):
