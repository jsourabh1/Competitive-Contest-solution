...
def solve():
	...
	index1=arr.index(maxx)
	index2=arr.index(minn)

	first=min(n-index1,index1+1)
	# print(first,n-index1,index1+1)
	second=min(n-index2,index2+1)
	# print(second,n-index2,index2+1)
	third=min(max(n-index2,n-index1),max(index1+1,index2+1))
	# print(third,max(n-index2,n-index1),max(index1+1,index2+1))
